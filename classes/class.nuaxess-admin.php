...
//		 }
		 ...
		 $formData['role']="user";
		 $formData['org_id']=0;
$formData['priv_additions']="N";
$formData['priv_terminations']='N';
$formData['priv_adjustments']='N';
$formData['priv_move_members']='N';
$formData['priv_view_invoice']='N';
$formData['priv_process_invoice']='N';
$formData['priv_receive_payment']='N';
$formData['priv_invoice_user']='N';
$formData['priv_invite_user']='N';
$formData['priv_add_user']='N';
$formData['priv_add_vendor']='N';
$formData['priv_edit_commissions']='N';
$formData['priv_view_commissions']='N';
$formData['priv_issue_quote']='N';
$formData['priv_add_plans']='N';
$formData['priv_edit_roles']='N';
$formData['priv_view_claims']='N';
$formData['priv_enroll_company']='N';
...
function makeInviteCode() {
		 ...
		 //
	 	 ...
	 	 $sql="select * from nua_company_invoice where month_id = '" . $data['id2'] . "' and company_id = " . $data['id'];
		     ...
		     $sql="select * from nua_company where id = " . $data['id'];
                     ...
                     if ($data['id2']=="2022-02") { $post['billing_date']="02/01/2022"; $post['due_date']="02/28/2022"; }
                     if ($data['id2']=="2022-03") { $post['billing_date']="03/01/2022"; $post['due_date']="03/31/2022"; }
                     if ($data['id2']=="2022-04") { $post['billing_date']="04/01/2022"; $post['due_date']="04/30/2022"; }
                     if ($data['id2']=="2022-05") { $post['billing_date']="05/01/2022"; $post['due_date']="05/31/2022"; }
                     if ($data['id2']=="2022-06") { $post['billing_date']="06/01/2022"; $post['due_date']="06/30/2022"; }
                     if ($data['id2']=="2022-07") { $post['billing_date']="07/01/2022"; $post['due_date']="07/31/2022"; }
                     if ($data['id2']=="2022-08") { $post['billing_date']="08/01/2022"; $post['due_date']="08/31/2022"; }
                     if ($data['id2']=="2022-09") { $post['billing_date']="09/01/2022"; $post['due_date']="09/30/2022"; }
		     ...
		     $fam_grand_total=0;
                     ...
                     foreach ($plans as $p) {
                            ...
                            $eec_count=0;
                            $fam_count=0;
                            $sql="select * from nua_monthly_member_census where company_id = " . $data['id'] . " and month_id = '" . $data['id2'] . "' and client_plan = '" . $p['plan_code'] . "'";
                            $cc=$this->X->sql($sql);
                            foreach($cc as $c) {
			    ...
			    $sql="select * from nua_company_invoice_detail where invoice_id = " . $invoice_id . " and plan_code = '" . $p['plan_code'] . "'";
                            ...
                            $post['fam_total']=number_format($fam_total,2);
                            $this->X->post($post);
                     }
	...
	function postAddEmployeeSmall($data) {
		 ...
		 $p['gender']=$post['gender'];
		 $p['status']="enrolled";
                 $sql="select * from nua_company_plan where company_id = " . $post['company_id'] . " and plan_code = '" . $post['plan'] . "'";
                 $t=$this->X->sql($sql);
                 $plan=$t[0];
		 ...
		 $p['apa_medical_plan']=$plan['APA_CODE'];
                 $p['company_id']=$post['company_id'];
                 $p['apa_medical_plan_level']=$post['coverage_level'];
		 ...
		 $employee_id=$this->X->post($p);
		      ...
		      $dep['last_name']=$post['last_name'];
                 ...
                 $month_id="2022-03";
                 if ($post['eff_dt']=="01/01/2022") $month_id="2022-01";
                 if ($post['eff_dt']=="02/01/2022") $month_id="2022-02";
                 if ($post['eff_dt']=="03/01/2022") $month_id="2022-03";
                 if ($post['eff_dt']=="04/01/2022") $month_id="2022-04";
                 if ($post['eff_dt']=="05/01/2022") $month_id="2022-05";
                 if ($post['eff_dt']=="06/01/2022") $month_id="2022-06";
                 if ($post['eff_dt']=="12/31/2021") $month_id="2021-12";
                 if ($post['eff_dt']=="11/30/2021") $month_id="2021-11";
                 if ($post['eff_dt']=="10/30/2021") $month_id="2021-10";
		 ...
		 $p['table_name']="nua_monthly_member_additions";
                 ...
                 if ($post['dependent']=='Y') {
                           ...
                           $c=$y[0]['c'];
                           $c++;
                           $p['dependent_code']="n" . $employee_id . "." . $c; 
                 } else {
                           $p['dependent_code']="";
                 }
                 ...
                 $p['first_name']=$post['first_name'];
                 $p['last_name']=$post['last_name'];
                 $p['middle_initial']=$post['middle_name'];
                 $p['dob']=$post['date_of_birth'];
                 $p['ssn']=$post['social_security_number'];
                 $p['gender']=$post['gender'];
                 $p['eff_dt']=$post['eff_dt'];
                 $p['apa_plan']=$plan['APA_CODE'];
                 $p['client_plan']=$plan['plan_code'];
                 $p['coverage_level']=$post['coverage_level'];
                 $price="0.00";
		 if ($post['coverage_level']=="EE"||$post['coverage_level']=="SI") $price=$plan['ee_price'];
		 if ($post['coverage_level']=="EC"||$post['coverage_level']=="EC2") $price=$plan['eec_price'];
		 if ($post['coverage_level']=="ES"||$post['coverage_level']=="ES2") $price=$plan['ees_price'];
		 if ($post['coverage_level']=="FAM"||$post['coverage_level']=="FA") $price=$plan['fam_price'];
                 $p['coverage_price']=$price;
                 $p['company_name']=$company['id'];
                 $p['plan_type']="*MEDICAL*";
                 $this->X->post($p);

                 if ($post['eff_dt']=="03/01/2022") {
...
// Members loaded in INVOICE LOAD
	...
	function getDuplicateEmployees($data) {
		...
		$cid = $data['data']['company_id'];
                ...
                $sql="update nua_census set alt_company_name = '" . $alt_company_name . "' where id = " . $census_id;
                $this->X->execute($sql);
...
$sql="select * from nua_employee_plan_options where employee_id = " . $user['employee_id'];
	...
	function getInvoiceList($data) {
		...
		if ($data['id']=="") {
                ...
                if ($month_id=='2022-01') $last_month='2021-12';
                if ($month_id=='2022-02') $last_month='2022-01';
                if ($month_id=='2022-03') $last_month='2022-02';
                if ($month_id=='2022-04') $last_month='2022-03';
                if ($month_id=='2022-05') $last_month='2022-04';
                if ($month_id=='2022-06') $last_month='2022-05';
                if ($month_id=='2022-07') $last_month='2022-06';
                if ($month_id=='2022-08') $last_month='2022-07';
                if ($month_id=='2022-09') $last_month='2022-08';
                if ($month_id=='2022-10') $last_month='2022-09';
                if ($month_id=='2022-11') $last_month='2022-10';
                if ($month_id=='2022-12') $last_month='2022-11';
                if ($month_id=='2023-01') $last_month='2022-12';
                ...
                $sql="select id, org_id, company_name, edf_routing, edf_day from nua_company where invoicing = 'Y' order by company_name";
                $d=$this->X->sql($sql);
                $list=array();
		foreach($d as $e) { 
                    ...
                    $sql="select * from nua_company_invoice where company_id = " . $e['id'] . " and month_id = '" . $month_id . "'";
                    $y=$this->X->sql($sql);
                    if (sizeof($y)==0) {
			 $e['grand_total']="";   
                         $e['invoice_number']="Not Invoiced";
                    } else {
                         $e['grand_total']=$y[0]['grand_total'];
                         $e['invoice_number']=$y[0]['invoice_number'];
                    } 
                    if ($e['edf_routing']=="") $e['eft']="N"; else $e['eft']="Y";

		    $sql="select count(*) as c from nua_monthly_member_census where company_id = " . $e['id'] . " and month_id = '" . $month_id . "'";
                    $y=$this->X->sql($sql);
                    $e['count']=$y[0]['c'];
		    $sql="select count(*) as c from nua_monthly_member_additions where company_id = " . $e['id'] . " and month_id = '" . $month_id . "'";
                    $y=$this->X->sql($sql);
                    $e['additions']=$y[0]['c'];
		    $sql="select count(*) as c from nua_monthly_member_terminations where company_id = " . $e['id'] . " and month_id = '" . $last_month . "'";
                    $y=$this->X->sql($sql);
                    $e['terminations']=$y[0]['c'];
		    $sql="select count(*) as c from nua_company_invoice_adjustments where company_id = " . $e['id'] . " and month_id = '" . $month_id . "'";
                    $y=$this->X->sql($sql);
                    $e['adjustments']=$y[0]['c'];
	...
	function getCompanyList($data) {
		...
		$user=$output['user'];
	        $output['id']=$data['id'];	
		$sql="select id, org_id, company_name, contact_name, contact_phone, invoicing, status, insured_employees, insured_lives, infinity_id from nua_company where 1 = 1 order by company_name";
                     if ($data['id']=="active") {
			$sql="select * from nua_company where org_id = " . $user['org_id'] . " and status in ('enrolled','terminated')  order by company_name";
                     }
                     if ($data['id']=="apa") {
			    $sql="select * from nua_company where id in (select distinct company_id from nua_census)  order by company_name";
			} 
                     if ($data['id']=="prospects") {
			    $sql="select * from nua_company where org_id = " . $user['org_id'] . " and status in ('prospect') order by company_name";
                        }
                     if ($data['id']=="enrolling") {
			    $sql="select * from nua_company where org_id = " . $user['org_id'] . " and status in ('enrolling') order by company_name";
                        }
